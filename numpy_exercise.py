...
print("-----------------------------------------------   STEP TWO   -----------------------------------------------")
print('The smallest sale was: $', salesArray.min())
print('The largest sale was: $', salesArray.max())
print()
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
credit_fees = np.round((salesArray * 0.02),2)
print(credit_fees)
print('Total credit card fees: $', np.round(credit_fees.sum(),2), '(rounded to the nearest cent.)')
print()
...
print("-----------------------------------------------   STEP SIX  -----------------------------------------------")
profit = np.subtract(salesArray, credit_fees)
print(profit)
print()
...
print(np.vstack((salesArray, newRegister)))
print()
